...
export default function ExperiencesPage() {
  ...
  const categories = [
    ...
    { value: "gastronomy", label: "Gastronomy", icon: Ship },
  ...
  return (
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="relative z-10 h-full flex items-center justify-center text-white px-4 pt-20">
          <div className="text-center max-w-4xl">
            ...
            <p className="text-xl md:text-2xl mb-8 max-w-3xl mx-auto opacity-90">
              From balloon tours to private yacht journeys, discover Turkey's most special moments
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="max-w-7xl mx-auto px-4 py-16">
        <h2 className="text-3xl font-bold mb-8 text-gray-900">Featured Experience</h2>
      ...
      <section className="max-w-7xl mx-auto px-4 pb-16">
        <h2 className="text-3xl font-bold mb-8 text-gray-900">Recent Experiences</h2>
      ...
      <section className="bg-tertiary-600 py-16">
        <div className="max-w-4xl mx-auto px-4 text-center text-white">
          <h2 className="text-3xl font-bold mb-6">
            Stay Updated on New Experiences
          </h2>
          <p className="text-xl mb-8 opacity-90">
            Don't miss Turkey's most special experiences. Subscribe to our weekly newsletter.
          </p>
      ...
      <section className="max-w-7xl mx-auto px-4 py-16">
        <div className="flex items-center justify-between mb-8">
          <h2 className="text-3xl font-bold text-gray-900">All Experiences</h2>
