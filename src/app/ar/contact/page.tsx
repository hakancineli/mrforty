...
export const metadata: Metadata = {
  title: 'اتصل بنا - MrForty | السفر الفاخر',
  description: 'تواصل مع MrForty. احصل على مساعدة مخصصة من مستشاري السفر الخبراء لدينا.',
}
      ...
      <section className="relative h-96 flex items-center justify-center overflow-hidden bg-gradient-to-br from-primary-600 to-primary-800">
        <div className="relative z-10 text-center text-white px-4">
          ...
          <p className="text-xl md:text-2xl max-w-3xl mx-auto">
            احصل على مساعدة مخصصة من مستشاري السفر الخبراء لدينا
          </p>
        </div>
      </section>
            ...
            <div>
              ...
              <form className="space-y-6">
                ...
                <div>
                  ...
                  <select className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent" title="الموضوع">
                    <option>معلومات عامة</option>
                    <option>حجز</option>
                    <option>دعم</option>
                    <option>شراكة</option>
                  </select>
              ...
              <div className="space-y-8">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">الإثنين - الجمعة: 09:00 - 18:00</p>
                  </div>
                </div>
                ...
                <div className="bg-white rounded-2xl shadow-lg overflow-hidden mt-8">
                  <h3 className="text-lg font-semibold mb-4 px-6 pt-6">الخريطة</h3>
